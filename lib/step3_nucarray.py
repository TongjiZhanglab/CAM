...
def step3_nucarray(conf_dict,logfile,filelist):
    ...
    if check_filelist(filelist,conf_dict['Step3_nucarray']['arrayall'])==0 or not os.path.isfile(conf_dict['Step3_nucarray']['arrayall']):
      # output _Nucleosome_Array_all.bed
